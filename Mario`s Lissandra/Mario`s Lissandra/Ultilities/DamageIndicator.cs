...
namespace Mario_sLissandra.Ultilities
{
    internal class DamageIndicator : Helpers
    {
        ...
        private static void Drawing_OnEndScene(EventArgs args)
        {
                ...
                )
            {
                ...
                if (GetCheckBoxValue(MenuTypes.Drawings, "damageDraw"))
                {
                ...
                if (GetCheckBoxValue(MenuTypes.Drawings, "statDraw"))
                {
                    //Statistics
                ...
                if (GetCheckBoxValue(MenuTypes.Drawings, "perDraw"))
                {
                    //Percent
